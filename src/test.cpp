...
//    mode = "test";
    if(mode == "train"){
        Mat img = cv::imread(prefix+"case3/balloon3-4.png");
        ...
        // save templates
        detector.writeClasses(prefix+"case3/%s_templ_small.yaml");

        // save infos,
        // in this simple case infos are not used
        shapes.save_infos(infos_have_templ, prefix + "case3/balloon_info_small.yaml");
        ...
        // read templates
        ids.push_back("balloon1");
        ids.push_back("balloon2");
        ids.push_back("balloon3");
